...
public class Splash_Leanback extends Activity {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    if (logindetails.getString("sid", "").equalsIgnoreCase("")) {
                        Intent i = new Intent(Splash_Leanback.this, LoginActivity.class);
                        overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                        startActivity(i);
                    } else {
                        Intent i = new Intent(Splash_Leanback.this, HomeActivity.class);
                        overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
                        startActivity(i);
                    }
                    Splash_Leanback.this.finish();
                }
            }, 3000);
        else{
            Intent i = new Intent(Splash_Leanback.this, HomeActivity.class);
