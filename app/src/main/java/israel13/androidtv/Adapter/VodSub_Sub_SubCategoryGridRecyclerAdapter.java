 ...
 */
public class VodSub_Sub_SubCategoryGridRecyclerAdapter extends RecyclerView.Adapter<VodSub_Sub_SubCategoryGridRecyclerAdapter.Myviewholder>
{
   ...
   public ArrayList<SetgetVodSubcategory> list;
    ...
    public VodSub_Sub_SubCategoryGridRecyclerAdapter(ArrayList<SetgetVodSubcategory> list, Context mContext) {
        this.list = list;
    ...
    public void onBindViewHolder(final Myviewholder holder, final int position) {
        ...
        if(home != null && position == home.getSelectedPosition(HomeActivity.VodSub_Sub_SubCategoryGridRecycler))
        {
        ...
        holder.totalview_child_vod_subcategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(home != null){
                    home.setSelectedPosition(HomeActivity.VodSub_Sub_SubCategoryGridRecycler, position);
                }
                if (list.get(position).getGotoact().equalsIgnoreCase("0")) {
                   ...
                   // ft1.setCustomAnimations(android.R.anim.slide_in_left,android.R.anim.slide_out_right);
                    ...
                    VodSubcategory_Fragment.vod_subcategory_name = list.get(position).getName();
                    VodSubcategory_Fragment.Cat_name=VodSub_Sub_Subcategory_Fragment.cat_name.getText().toString();
                    VodSubcategory_Fragment.Cat_name=VodSub_Sub_Subcategory_Fragment.Cat_name+" > "+list.get(position).getName();
