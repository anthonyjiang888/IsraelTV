...
public class VodSub_SubCategoryGridAdapter extends BaseAdapter {
    ...
    public VodSub_SubCategoryGridAdapter(ArrayList<SetgetVodSubcategory> list, Context mContext) {
        this.list = list;
