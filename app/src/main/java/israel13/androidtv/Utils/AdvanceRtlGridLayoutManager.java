...
public class AdvanceRtlGridLayoutManager extends GridLayoutManager {



    public AdvanceRtlGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public AdvanceRtlGridLayoutManager(Context context, int spanCount) {
        super(context, spanCount);
    }

    public AdvanceRtlGridLayoutManager(Context context, int spanCount, int orientation, boolean reverseLayout) {
