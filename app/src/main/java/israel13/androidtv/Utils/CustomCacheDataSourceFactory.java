...
public class CustomCacheDataSourceFactory implements DataSource.Factory {
    ...
    public static final long DEFAULT_MAX_CACHE_SIZE = 1024 * 1024 * 1024; // 1024 Mb
    ...
    public CustomCacheDataSourceFactory(Context context, long maxCacheSize, long maxFileSize) {
        super();
    ...
    public DataSource createDataSource() {
        ...
        SimpleCache simpleCache = new SimpleCache(new File(context.getCacheDir(), Constant.CACHE_EXO_DEFAULT_NAME), evictor);
